      ...
      <div class="content-container">
        <div class="ui form">
          ...
          <div class="inline field">
            ...
            <input class="ui" type="number" .value="${this.minConductivity}" min="${this.minConductivityValue}" @input="${evt => this.minConductivity = evt.target.value}"/>

            <label>${i18next.t('vox_filter_max')}</label>
            <input class="ui" type="number" .value="${this.maxConductivity}" max="${this.maxConductivityValue}" @input="${evt => this.maxConductivity = evt.target.value}"/>
